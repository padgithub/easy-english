...
public class FindPlaceRequest_Google: FindPlaceRequest {
	...
	public func execute() {
		...
		//https://maps.googleapis.com/maps/api/place/autocomplete/json?input=D&types=geocode&sensor=false&key=AIzaSyCkKWaljrxm84J3vxiFncoZYs5K6aagW1I
		let url = URL(string: "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=\(input.urlEncoded)&key=\(APIKey)&types=geocode&sensor=false")!
